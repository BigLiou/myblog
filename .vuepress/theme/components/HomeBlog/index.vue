<template>
  <div class="home-blog">
    ...
    <lottie-com class="kiki" :lottieJson="kiki"></lottie-com>
    <lottie-com class="gamePad" ref="gamePad" :lottieJson="gamepad" :loop="false" @ready="lottieLoaded"
      @click.native="goHero"></lottie-com>
...
import kiki from '@theme/assets/kiki.json'
import gamepad from '@theme/assets/gamepad.json'

export default defineComponent({
  components: { NoteAbstract, TagList, FriendLink, ModuleTransition, PersonalInfo, RecoIcon, LottieCom },
  setup(props, ctx) {
    ...
    return { recoShowModule, heroImageStyle, bgImageStyle, ...toRefs(state), getOneColor, kiki, gamepad }
  },
  methods: {
    ...
    lottieLoaded() {
      const animate = this.$refs.gamePad.animate
