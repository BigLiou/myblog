...
import LottieCom from '@theme/components/lottie/LottieCom'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    return {
      ...
      ...toRefs(state),
      getOneColor,
      kikiJson: 'https://img.bigliou.com/lottieJson/kiki.json',
      gamePadJson: 'https://img.bigliou.com/lottieJson/gamepad.json',
    }
  },
  methods: {
