<template>
  <section class="theme-container" v-if="!noFoundPageByTencent">
    <article class="content">
      ...
      <router-link to="/">迷路了?</router-link>
      <lottie-com :lottieJson="page404"></lottie-com>
    </article>
  </section>
</template>
...
import page404 from '@theme/assets/404.json'
...
export default defineComponent({
  ...
  setup (props, ctx) {
    ...
    return { noFoundPageByTencent, getMsg, page404 }
  }
})
</script>
